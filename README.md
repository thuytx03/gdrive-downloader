...
### Cho macOS
1. Tải file `.dmg` hoặc `.app` mới nhất từ trang [Releases](https://github.com/thuytx03/google-drive-downloader/releases).
...
### Cho Windows
1. Tải file cài đặt `.exe` mới nhất từ trang [Releases](https://github.com/thuytx03/google-drive-downloader/releases).
